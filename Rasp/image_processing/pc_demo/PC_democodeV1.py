...
while True:
    ...
    for j, contour in enumerate(contourR):
        ...
        if (((len(approx)==4) and (1000<red_area < 30000)) ):
                ...
                cv2.putText(red,str("w:"+str(w)+" h:"+str(h)),(cx+5,cy+5),cv2.FONT_HERSHEY_SIMPLEX,FONT_SIZE,(255,255,255),FONT_THIKNESS,cv2.LINE_AA)
                CANS.append((red_area,cx,cy,(0,0,255),h))
    ...
    for i, contour in enumerate(contourG):
        ...
        if (((len(approx)==4) and (1000<green_area < 30000)) ):
                ...
                CANS.append((green_area,cx,cy,(0,255,0),h))
