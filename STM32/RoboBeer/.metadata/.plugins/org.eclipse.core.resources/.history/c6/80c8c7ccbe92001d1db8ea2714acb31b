...
#define SECRET_WEAPON_Pin GPIO_PIN_7
#define SECRET_WEAPON_GPIO_Port GPIOC
...
#define RASP_USART1_TX_Pin GPIO_PIN_6
#define RASP_USART1_TX_GPIO_Port GPIOB
#define RASP_USART1_RX_Pin GPIO_PIN_7
#define RASP_USART1_RX_GPIO_Port GPIOB
